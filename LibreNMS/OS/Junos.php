...
class Junos extends \LibreNMS\OS implements SlaDiscovery, OSPolling, SlaPolling, TransceiverDiscovery, WirelessRsrpDiscovery, WirelessRsrqDiscovery, WirelessSnrDiscovery, WirelessRssiDiscovery
{
    ...
    public function discoverWirelessRsrp()
    {
        ...
        foreach ($oids as $index => $entry) {
            $sensors[] = new WirelessSensor('rsrp', $this->getDeviceId(), $oid . $index, 'junos', $index, 'Modem RSRP', null, 1, 1, 'sum', null, null, null, -100);
        }
        return $sensors;
    }
    ...
    public function discoverWirelessRsrq()
    {
        ...
        foreach ($oids as $index => $entry) {
            $sensors[] = new WirelessSensor('rsrq', $this->getDeviceId(), $oid . $index, 'junos', $index, 'Modem RSRQ', null, 1, 1, 'sum', null, null, null, -20);
        }
        return $sensors;
    }
    ...
    public function discoverWirelessSnr()
    {
        ...
        foreach ($oids as $index => $entry) {
            $sensors[] = new WirelessSensor('snr', $this->getDeviceId(), $oid . $index, 'junos', $index, 'Modem SNR', null, 1, 1, 'sum', null, null, null, 0);
        }
        return $sensors;
    }
    ...
    public function discoverWirelessRssi()
    {
        ...
        foreach ($oids as $index => $entry) {
            $sensors[] = new WirelessSensor('rssi', $this->getDeviceId(), $oid . $index, 'junos', $index, 'Modem RSSI', null, 1, 1, 'sum', null, null, null, -85);
        }
        return $sensors;
    }
