...
foreach (dbFetchRows($sql, $param) as $alertlog) {
    ...
    $response[] = [
        ...
        'verbose_details' => "<button type='button' class='btn btn-default fa fa-square-info command-alert-details' style='display:none' aria-label='Details' id='alert-details' data-alert_log_id='{$alert_log_id}'></button>",
